...
class MA_VecTask(Env):
    ...
    def __init__(self, config, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture: bool = False, force_render: bool = False): 
        ...
        """
        self.possible_agents = [f"agent_{i}" for i in range(self.cfg["env"]["numAgents"])]
    ...
    def random_actions(self) -> torch.Tensor:
        ...
        Returns:
            A buffer of zero torch actions
        """
        actions = 2 * torch.rand([self.num_envs, self.num_agents, self.num_actions], dtype=torch.float32, device=self.rl_device) - 1
    ...
    def __parse_sim_params(self, physics_engine: str, config_sim: Dict[str, Any]) -> gymapi.SimParams:
        ...
        sim_params.physx.contact_offset = 0.016
